...
'Enter registered job title\r\n'
WebUI.setText(findTestObject('Page_OrangeHRM/job/job_jobTitles/input_JobTitle'), 'QA Engineer')

WebUI.click(findTestObject('Page_OrangeHRM/job/job_jobTitles/button_SaveJobTitle'))

'Verify job title already exists\r\n'
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/job/job_jobTitles/error_AlreadyExists'), 0)
