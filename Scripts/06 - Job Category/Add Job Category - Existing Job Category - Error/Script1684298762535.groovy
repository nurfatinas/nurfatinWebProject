...
'Enter job existing category'
WebUI.setText(findTestObject('Page_OrangeHRM/job/job_jobCategory/input_JobCategory'), 'IT Professionals')

WebUI.click(findTestObject('Page_OrangeHRM/job/job_jobCategory/button_SaveJobCategory'))

'Verify error job category already exists\r\n'
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/job/job_jobCategory/error_AlreadyExists'), 0)
