...
'Enter registred username'
WebUI.setText(findTestObject('Page_OrangeHRM/user_addUser/input_Username'), 'Admin')

'Verify error username already exists\r\n'
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/user_addUser/error_AlreadyExists'), 0)
