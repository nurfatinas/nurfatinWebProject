...
shortPassword = CustomKeywords.'master.RandomNS.genRandomString'(6)

'Enter less than 8 characters password'
WebUI.setText(findTestObject('Page_OrangeHRM/user_addUser/input_Password'), shortPassword)

'Enter less than 8 characters password'
WebUI.setText(findTestObject('Page_OrangeHRM/user_addUser/input_ConfirmPassword'), shortPassword)

WebUI.click(findTestObject('Page_OrangeHRM/user_addUser/button_SaveAddUser'))

'Verify error password should have at least 7 characters'
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/user_addUser/error_ShortPassword'), 0)
