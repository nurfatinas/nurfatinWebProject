...
randomString = CustomKeywords.'master.RandomNS.genRandomString'(4)

'Enter less than 5 character username'
WebUI.setText(findTestObject('Page_OrangeHRM/user_addUser/input_Username'), randomString)

'Verify error username should ay least 5 characters'
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/user_addUser/error_ShortUsername'), 0)
