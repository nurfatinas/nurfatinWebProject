...
WebUI.setText(findTestObject('Page_OrangeHRM/user_addUser/input_ConfirmPassword'), 'charlie123$')

WebUI.click(findTestObject('Page_OrangeHRM/user_addUser/button_SaveAddUser'))

'Verify error password do not match'
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/user_addUser/error_PasswordsDoNotMatch'), 0)
