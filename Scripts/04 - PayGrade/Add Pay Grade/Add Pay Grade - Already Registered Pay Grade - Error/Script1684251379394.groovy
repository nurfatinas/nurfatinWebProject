...
'Enter registered pay grade '
WebUI.setText(findTestObject('Page_OrangeHRM/job/job_payGrades/input_PayGradeName'), 'Grade 1')

WebUI.click(findTestObject('Page_OrangeHRM/job/job_payGrades/button_SavePayGrade'))

'Verify error pay grade already exists\r\n'
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/job/job_payGrades/error_PayGradeAlreadyExists'), 0)
