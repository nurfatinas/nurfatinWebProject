...
WebUI.setText(findTestObject('Page_OrangeHRM/job/job_employementStatus/input_EmployementStatus'), 'Freelance')

WebUI.click(findTestObject('Page_OrangeHRM/job/job_employementStatus/button_SaveEmployementStatus'))

WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/job/job_employementStatus/error_AlreadyExists'), 0)
